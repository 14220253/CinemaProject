    ...
    <div class="signin">
        <div class="content">
          ...
          <form method="post" class="form">
            <div class="inputBox">
                <input type="text" name="username" value="<?= htmlspecialchars($_POST["username"] ?? "")?>" required> <!--value yang aku tuli ini agar inputannya tidak hilang saat direfresh-->
                <i>Username</i>
            </div>
            <div class="inputBox">
            ...
            <div class="links">
                ...
                <a href="signup-page.html">Signup</a> <!--iki nama signup ku-->
            </div>
            <div class="inputBox">
